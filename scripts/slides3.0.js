...
$(document).ready(function(){
	...
	if (album.substring(album.length-5).toUpperCase() == ".JSON") {
		album = album.slice(0, album.length-5);
	}
	
	if (openAlbum(album)) {
		startSlides();
	} else {
		document.writeln("Invalid album.");
		//return;
	}
});
